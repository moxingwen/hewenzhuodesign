...
<div class="container">
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <form action="${pageContext.request.contextPath}/login.action" method="post" id="myform">
                <div class="panel loginbox">
                    ...
                    <div class="panel-body"style="padding:30px; padding-bottom:10px; padding-top:10px;">
                        ...
                        <div class="form-group v_container">
                            <div class="field">
                                <input type="text" class="input input-big" name="code" id="code_input" placeholder="验证码" />
                                <div id="v_container" style="width: 100px;height: 45px;" class="passcode"></div>
                            </div>
                        </div>
                    <div style="padding:30px;">
                        <input type="button" id="my_button" class="button button-block bg-main text-big input-big" value="登录">
                    </div>
                </div>
            </form>
        </div>
